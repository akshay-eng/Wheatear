...
`wheatear.model_map` (which stays as-is for backward compatibility and as the
...
from wheatear.model_matrix.types import ModelProfile, Recommendation, ScoredCandidate
