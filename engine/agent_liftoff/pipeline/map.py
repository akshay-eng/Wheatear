...
from agent_liftoff.errors import MapError
...
def _map_to_orchestrate(
    ...
    for raw_knowledge in import_result.raw_knowledge_refs:
        if raw_knowledge.file_path is not None or raw_knowledge.is_file_upload:
            ...
            # upload is something Agent Liftoff can stage. An n8n
            ...
            # knowledge base, not a reference Agent Liftoff can just copy over.
