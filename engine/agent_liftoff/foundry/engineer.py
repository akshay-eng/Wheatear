...
from agent_liftoff.foundry.cases import derive_cases, render_tests
from agent_liftoff.foundry.emit import emit_adapter
from agent_liftoff.foundry.sandbox import Sandbox
...
def _implementations(
    ...
    from agent_liftoff.foundry.emit import _derive_name  # noqa: PLC0415 - one naming rule, shared
