...
Auth is an Azure AD bearer token for the environment's Dataverse URL. Agent Liftoff
...
from agent_liftoff.connectors.copilot_studio.solution_importer import (
        ...
        if unrecognized:
            ...
            result.gaps.append(
                ProbeGap(
                    ...
                    detail=(
                        "Their `componenttype` maps to no entity kind Agent Liftoff models, so "
