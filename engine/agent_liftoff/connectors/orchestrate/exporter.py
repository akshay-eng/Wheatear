...
Tool *implementations* are out of scope (Agent Liftoff doesn't invent function
...
from agent_liftoff.model_map import resolve_target_model
...
def knowledge_base_specs(agent: Agent) -> list[dict]:
    ...
    pointed at something Agent Liftoff never had (a SharePoint site, a
...
def _connection_spec(conn) -> dict:
    return {
        ...
        # Agent Liftoff never auto-fills credentials; the human populates this.
