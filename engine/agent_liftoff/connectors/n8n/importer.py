...
flagged). Assembly reuses `agent_liftoff/workflow.py`.
...
from agent_liftoff.connectors.n8n import graph, http_tools
from agent_liftoff.ir.schema import Agent, AgentRef, Workflow
