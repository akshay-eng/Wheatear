"""Platform connector registry: the seam that makes Agent Liftoff IR-centric.
...
from agent_liftoff.errors import UnsupportedCorridorError
...
PLATFORMS: dict[str, PlatformSpec] = {
    "copilot-studio": PlatformSpec(
        ...
        importer_module="agent_liftoff.connectors.copilot_studio.importer",
        exporter_module="agent_liftoff.connectors.copilot_studio.exporter",
    ),
    "orchestrate": PlatformSpec(
        key="orchestrate",
        display_name="IBM watsonx Orchestrate",
        importer_module="agent_liftoff.connectors.orchestrate.importer",
        exporter_module="agent_liftoff.connectors.orchestrate.exporter",
    ),
    "n8n": PlatformSpec(
        key="n8n",
        display_name="n8n",
        importer_module="agent_liftoff.connectors.n8n.importer",
