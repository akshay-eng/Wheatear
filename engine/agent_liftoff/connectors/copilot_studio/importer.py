...
Copilot Studio agents reach Agent Liftoff via one of two real export shapes:
...
from agent_liftoff.connectors.copilot_studio import mcs_yaml_importer, solution_importer
from agent_liftoff.connectors.copilot_studio.common import ImportResult  # re-exported for existing call sites
...
def import_agent(path: Path) -> ImportResult:
    ...
    raise FileNotFoundError(
        f"{path} doesn't look like a Copilot Studio export Agent Liftoff recognizes "
