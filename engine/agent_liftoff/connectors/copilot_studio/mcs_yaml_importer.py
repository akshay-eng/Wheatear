...
is one of two real-world Copilot Studio export shapes Agent Liftoff handles; see
...
from agent_liftoff.connectors.copilot_studio.common import ImportResult, RawKnowledgeRef
from agent_liftoff.ir.schema import Agent, DialogNode, DialogNodeKind, Topic
